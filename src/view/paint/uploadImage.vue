...
                            <Icon :style="pStyle" type="ios-download-outline" @click.native="handleDown(item)"></Icon>
                            <Icon :style="pStyle" type="ios-trash-outline" @click.native="handleRemove(item)"></Icon>
                            </div>
                        </template>
                        <template v-else>
...
                        </template>
                    </div>
                    <h4 v-show="defaultList.length <= 0 && !uploadFlag">暂无图片数据</h4>
                    <div :style="pStyle">
                        <Upload ref="upload"
...
            },
            getShowName(val) {
                this.pStyle.display = val == '图片上传' ? 'inline-block' : 'none';
                this.uploadFlag = val == '图片上传' ? true : false;
            }
        },
        mounted() {
